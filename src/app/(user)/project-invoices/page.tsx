    ...
    <>
      ...
      >
        <div className="my-3 w-full items-start justify-center sm:border-r-2 sm:px-5">
          ...
          <div className="mx-auto my-5 w-full">
            <div className="w-full overflow-x-auto">
              ...
              <Button
                ...
                type="button"
                className="ml-2 mt-2 flex items-center justify-center rounded-[5px] border border-blue-600 bg-[#ff0055] px-4 py-2 text-sm font-bold text-white"
              >
                Add Item
              </Button>
            </div>
          ...
          <p className="text-md my-5 font-bold text-slate-700 sm:mx-3">
            TOTAL: {total}
          </p>

          <div className="mt-5">
            <Button
              className="my-2 flex items-center justify-center rounded-[5px] border border-blue-600 bg-[#ff0055] px-4 py-2 text-sm font-bold text-white"
              type="submit"
            >
              Download PDF
            </Button>
          ...
          <div id="invoiceContent" className="p-5">
            <div className="mx-auto flex w-full justify-between border-b border-gray-200 pb-4">
              <div>
                ...
                <p className="text-gray-400">Invoice Number: {invoiceNumber}</p>
