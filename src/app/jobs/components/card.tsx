            ...
            <div className="grid lg:grid-cols-3 sm:grid-cols-2 gap-3">
                <Card className="rounded-2xl p-5 my-2">
                    ...
                    <div className="project-description my-3">
                       <span className="text-sm font-light">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</span>
                    </div>
                    <div className="shrink-0 bg-border h-[1px] w-full"></div>
                    <span className="text-xs text-slate-500 flex items-center my-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="mr-3" fill="text-slate-500" viewBox="0 0 256 256"><path d="M134,80v44.6l37.09,22.25a6,6,0,0,1-6.18,10.3l-40-24A6,6,0,0,1,122,128V80a6,6,0,0,1,12,0Zm90-22a6,6,0,0,0-6,6V87.36c-7.48-8.83-14.94-17.13-23.53-25.83a94,94,0,1,0-1.95,134.83,6,6,0,0,0-8.24-8.72A82,82,0,1,1,186,70c9.24,9.36,17.18,18.3,25.31,28H184a6,6,0,0,0,0,12h40a6,6,0,0,0,6-6V64A6,6,0,0,0,224,58Z"></path></svg>
                            15hrs ago
                        </span> 
                </Card>
                <Card className="rounded-2xl p-5 my-2">
